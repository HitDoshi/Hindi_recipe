...
class DisplayFavRecipe extends StatefulWidget {
  ...
  const DisplayFavRecipe({Key? key,required this.type_id,required this.row_id,
  ...
  @override
  State<DisplayFavRecipe> createState() => _DisplayFavRecipeState();
}

class _DisplayFavRecipeState extends State<DisplayFavRecipe> {
...
*/
                    ...
                    if(f==1) {
                      ...
                      readFavData.clear();
                      readFavData = (await favDBHandler?.readData())!;
                      Navigator.of(context).pop(readFavData);
                      setState(() {
                        star = "assets/images/stargray.png";
                      });
                    }
